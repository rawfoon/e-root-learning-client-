    ...
    return (
        ...
        <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center dark:bg-gray-900 dark:text-gray-100">
          ...
          <div className="md:w-1/2 px-8 md:px-16">
            ...
            <button onClick={handleGoogleSignIn} className="bg-white border py-2 w-full rounded-xl mt-5 flex justify-center items-center text-sm  hover:scale-105 duration-300 text-[#002D74] dark:bg-slate-300">
              <svg
                className="mr-3"
            ...
            <button onClick={handleGithubSignIn} className="bg-white border py-2 w-full rounded-xl mt-5 flex justify-center items-center text-sm  hover:scale-105 duration-300 text-[#002D74] dark:bg-slate-300">
            <svg className="mr-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" width="25px">
...
{/* 
            ...
            <div className="mt-3 text-xs flex justify-between items-center text-[#002D74]">
              ...
              <Link to='/login' className="py-2 px-5 bg-white border rounded-xl hover:scale-110 duration-300 dark:bg-slate-300">
                Login
              </Link>
            </div>
          </div>
